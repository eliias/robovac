...
import type { Hints } from "../../../lib/core/snapshot.js";
import { TERMS, termHref } from "../../../lib/terms.js";
import { candidatesSql, snapshotSql } from "./queries.js";
import { buildSnapshot, verdict } from "./report.js";
...
const server = new McpServer({ name: "robovac", version: "0.2.0" });
